...
export default function ProjectTeamView() {
  ...
  const { data, isLoading, isError } = useQuery<TeamMembers>({
    ...
    return (
      <>
        ...
        <nav className="my-5 flex gap-3 flex-col sm:flex-row">
          ...
          <Link
            className=" bg-fuchsia-600 hover:bg-fuchsia-700 px-10 py-3 text-white text-xl font-bold cursor-pointer transition-colors text-center"
